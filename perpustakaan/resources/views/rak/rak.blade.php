              ...
              <form>
                <div class="card-body">
                  ...
                  @error('lokasi')
                        ...
                        @enderror
                  <div class="form-group">
                    <label for="exampleInputBuku1">Buku</label>
                    <input type="text" class="form-control @error('buku') is-invalid @enderror" name="buku" placeholder="Enter Buku">{{ $rak->buku->id_buku }}
                  </div>
                  @error('buku')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
